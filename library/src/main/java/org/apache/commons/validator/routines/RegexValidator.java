 ...
 * </ul>
 * <p>
 * Cached instances pre-compile and re-use {@link java.util.regex.Pattern}(s) - which according
 * to the {@link java.util.regex.Pattern} API are safe to use in a multi-threaded environment.
 *
